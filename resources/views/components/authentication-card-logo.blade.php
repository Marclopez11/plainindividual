<a href="/">
    <div class="relative">
        <!-- Reemplazamos el logo por un diseño más moderno relacionado con el soporte educativo -->
        <svg xmlns="http://www.w3.org/2000/svg" class="h-20 w-20" viewBox="0 0 512 512" fill="none">
        ...
        <div class="absolute -top-4 -right-4 w-12 h-12 bg-white rounded-full blur-xl opacity-30"></div>
    </div>
</a>
